                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 position-relative">
                        <div class="icon-bx-wraper equal-col p-t30 p-b20 left">
                            <div class="icon-lg text-primary radius"> <a href="javascript:void(0);" class="icon-cell"><i
                    ...
                    <div class="col-md-4 col-lg-4 position-relative">
                        ...
                        <div class="input-group equal-col p-t40 p-b20">
                            <input name="dzEmail" placeholder="Email address" required="required" class="form-control"
                                type="email">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_about">
                        ...
                        <p><strong>Our mission </strong>is to provide the best value and service to our clients. Here we
                            are always ready to help you. We are devoted to the task to construct your dream to fit all
                            your needs and preference. We realize that our success starts and ends with our employees so
                            we try to provide excellent work to our clients with a level of expertise.</p>
                        <ul class="dez-social-icon dez-border">
                            <li><a target="_blank" href="https://www.facebook.com/dexignzone/"><i
                                        class="fab fa-facebook-f"></i></a></li>
                            <li><a target="_blank" href="https://twitter.com/dexignzones"><i
                                        class="fab fa-twitter"></i></a></li>
                            <li><a target="_blank" href="https://www.linkedin.com/in/dexignzone"><i
                                        class="fab fa-linkedin-in"></i></a></li>
                            <li><a target="_blank" href="https://www.instagram.com/dexignzone/"><i
                    ...
                    <div class="widget recent-posts-entry">
                        ...
                        <div class="widget-post-bx">
                            <div class="widget-post clearfix">
                                ...
                                <div class="dez-post-info">
                                    <div class="dez-post-header">
                                        <h6 class="post-title text-uppercase"><a href="blog-single.html">Creative
                                                Construct</a></h6>
                                    </div>
                                    <div class="dez-post-meta">
                                        <ul>
                                            <li class="post-author">By <a href="javascript:void(0);">Jemmy</a></li>
                            ...
                            <div class="widget-post clearfix">
                                ...
                                <div class="dez-post-info">
                                    <div class="dez-post-header">
                                        <h6 class="post-title text-uppercase"><a href="blog-single.html">Professional
                                                Services</a></h6>
                                    </div>
                                    <div class="dez-post-meta">
                                        <ul>
                                            <li class="post-author">By <a href="javascript:void(0);">Jone Doe</a></li>
                                            <li class="post-comment"><i class="fa fa-comments"></i> 28</li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="widget-post clearfix">
                                ...
                                <div class="dez-post-info">
                                    <div class="dez-post-header">
                                        <h6 class="post-title  text-uppercase"><a href="blog-single.html">Construction
                                                Planning</a></h6>
                                    </div>
                                    <div class="dez-post-meta">
                                        <ul>
                                            <li class="post-author">By <a href="javascript:void(0);">Frenchi</a></li>
                                            <li class="post-comment"><i class="fa fa-comments"></i> 28</li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_getintuch">
                        ...
                        <ul>
                            <li><i class="fas fa-map-marker-alt"></i><strong>address</strong> demo address #8901 Marmora
...
<script src="/template/dinas/plugins/bootstrap-select/bootstrap-select.min.js"></script><!-- FORM JS -->
<script src="/template/dinas/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.js"></script><!-- FORM JS -->
<script src="/template/dinas/plugins/magnific-popup/magnific-popup.js"></script><!-- MAGNIFIC POPUP JS -->
<script src="/template/dinas/plugins/counter/waypoints-min.js"></script><!-- WAYPOINTS JS -->
<script src="/template/dinas/plugins/counter/counterup.min.js"></script><!-- COUNTERUP JS -->
<script src="/template/dinas/plugins/imagesloaded/imagesloaded.js"></script><!-- IMAGESLOADED -->
<script src="/template/dinas/plugins/perfect-scrollbar/js/perfect-scrollbar.min.js"></script><!-- Perfect Scrollbar -->
